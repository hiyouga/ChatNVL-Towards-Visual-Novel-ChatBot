...
CUDA_VISIBLE_DEVICES=0 python ~/chatglm_tuning/src/finetune.py \
    ...
    --output_dir all_230424_lora_qkv_whole_no \
    --overwrite_cache \
...
CUDA_VISIBLE_DEVICES=0 python ~/chatglm_tuning/src/finetune.py \
    ...
    --dataset_dir ../../data \
    --checkpoint_dir all_230424_lora_qkv_whole_no \
    --output_dir all_230424_lora_qkv_whole_no_eval_koikake \
    --overwrite_cache \
...
CUDA_VISIBLE_DEVICES=0 python ~/chatglm_tuning/src/finetune.py \
    ...
    --dataset_dir ../../data \
    --checkpoint_dir all_230424_lora_qkv_whole_no \
    --output_dir all_230424_lora_qkv_whole_no_eval_alpaca \
    --overwrite_cache \
    --per_device_eval_batch_size 8 \
    --max_samples 100 \
    --predict_with_generate
